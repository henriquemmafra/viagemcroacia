...
export const walletItems = [
  ...
  { id:'dubrovnik-pass-henrique', category:'Passes', title:'Dubrovnik Pass - Henrique', subtitle:'3 dias · código FW321KW4', date:'08–09 set', codeAsset:'assets/tickets/dubrovnik-pass-henrique.png', note:'Ônibus: após o primeiro uso, guardar o ticket impresso.' },
  { id:'dubrovnik-pass-cibele', category:'Passes', title:'Dubrovnik Pass - Cibele', subtitle:'3 dias · código JL67A7MI', date:'08–09 set', codeAsset:'assets/tickets/dubrovnik-pass-cibele.png', note:'Ônibus: após o primeiro uso, guardar o ticket impresso.' },
  { id:'wizz-henrique', category:'Voos', title:'Wizz Air - Henrique', subtitle:'W6 2256 · DBV → BUD · assento 4B', date:'09 set · 14:10', locator:'KWKWWW', codeAsset:'assets/tickets/wizz-henrique-barcode.png', note:'Assento 4B · confirmação KWKWWW · porta fecha 13h40.' },
  { id:'wizz-cibele', category:'Voos', title:'Wizz Air - Cibele', subtitle:'W6 2256 · DBV → BUD · assento 4A', date:'09 set · 14:10', locator:'KWKWWW', codeAsset:'assets/tickets/wizz-cibele-barcode.png', note:'Assento 4A · confirmação KWKWWW · porta fecha 13h40.' },
