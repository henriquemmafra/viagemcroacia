...
export function applyPulaSep14LivePatch() {
  ...
  day.events = [
    ...
    ev('14:00','Almoço + escolher ônibus Pula → Rovinj',{ end:'15:00', icon:'🍽️', location:loc('Pula Bus Station','Trg 1. istarske brigade 1, 52100 Pula, Croatia'), status:'to-book', note:'A volta permanece sem horário fixo. Abrir a Arriva, escolher a saída que fizer sentido depois do almoço e só então comprar.', buyUrl:ARRIVA_PULA_ROVINJ}),
    ev('15:00','Pula livre até o horário de volta escolhido',{ icon:'☀️', location:loc('Pula Old Town','Pula Old Town, Pula, Croatia'), note:'Sem compromisso artificial depois das 15:00. Após comprar a volta, ajustar o tempo livre ao horário real do ônibus.'})
  ];
